          ...
          <Card maxW="sm" mx={5}>
            <CardBody>
              ...
              <Stack mt="6" spacing="3">
                ...
                <Text>
                  My AP CSA Final Project. It's a Java program that generates a
                  maze and finds the optimal path to solve it. You also have the
                  option to create you own maze.
                </Text>
              </Stack>
            </CardBody>
            <CardFooter>
